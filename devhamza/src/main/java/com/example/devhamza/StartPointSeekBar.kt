...
/**
 * Created by devhamza090 on 04/02/24.
 */
class StartPointSeekBar @JvmOverloads constructor(
    ...
    private var thumbHalfWidth: Float
    private var thumbHalfHeight: Float
    ...
    init {
        ...
        if (thumbImageDrawable == null) {
            thumbImageDrawable =
                ResourcesCompat.getDrawable(resources, R.drawable.seek_thumb_normal, null)
        }
        ...
        if (thumbImagePressedDrawable == null) {
            thumbImagePressedDrawable =
                ResourcesCompat.getDrawable(resources, R.drawable.seek_thumb_pressed, null)
        }
    ...
    private fun drawThumb(screenCoord: Float, pressed: Boolean, canvas: Canvas) {
        canvas.drawBitmap(
            if (pressed) thumbPressedImage else thumbImage, screenCoord
                    - thumbHalfWidth,
